...
def setup():
	...
	valueDict = {'botStatus':sitdown, 'music':'off', 'light':'off'}
...
def voiceRecogize(commandline):
	...
	if findValue(commandline, 'up'):
		print 'Robot standing up'
		valueDict['botStatus'] = standup
		
	if findValue(commandline, 'down'):
		print 'Robot sitting down', sitdown
		valueDict['botStatus'] = sitdown
